...
import { Button, Modal, Paper, Divider, Text } from "@mantine/core";
import * as React from "react";
import { BsInfoCircle } from "react-icons/bs";
import { Whatsnew } from "./thread/Whats-New";
  ...
  return (
    <>
      <Modal.Root opened={opened} onClose={close} size="lg">
        ...
        <Modal.Content>
          <Modal.Body>
            <Paper className="mx-auto grid w-full max-w-2xl place-items-start space-y-4 pt-4">
              <Whatsnew />
